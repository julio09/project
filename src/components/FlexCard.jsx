...
const FlexCard = () => {
  return (
    <>
    <section className=' flex items-start h-screen mt-20 bg-[#F0F0F0] gap-[40px] py-[80px] px-[124px] '>
      <div className='relative flex px-[48px] py-[5px] gap-[10px] items-start self-stretch flex-1 '>
        <img src={Home} alt='' className='absolute bottom-[49px] -left-32 w-[844px] h-[800px] object-contain '/>
      </div>
      <div className='flex flex-col items-start gap-[24px] flex-1'>
        ...
        <div className='grid grid-cols-2 items-start gap-[24px] self-stretch'>
          <div className='bg-white pt-[28px] px-[28px] pb-[90px] items-start gap-[24px] rounded-[14px] flex flex-col '>
          ...
          <div className='bg-white pt-[28px] px-[28px] pb-[65px] items-start gap-[24px] rounded-[14px] flex flex-col '>
            <div className='items-center justify-center flex px-3 py-2 rounded-[14px] bg-[#FFDDD6] '>
              <span className='text-[#F44236] leading-normal font-semibold text-[28px]'>01.</span>
            </div>
            <p className='self-stretch text-black text-[22px] font-bold leading-normal uppercase'>
          ...
          <div className='bg-white pt-[28px] px-[28px] pb-[59px] items-start gap-[24px] rounded-[14px] flex flex-col '>
            <div className='items-center justify-center flex px-3 py-2 rounded-[14px] bg-[#DBEFDC] '>
              <span className='text-[#4CB050] leading-normal font-semibold text-[28px]'>01.</span>
            </div>
            <p className='self-stretch text-black text-[22px] font-bold leading-normal uppercase'>
          ...
          <div className='bg-white pt-[28px] px-[28px] pb-[90px] items-start gap-[24px] rounded-[14px] flex flex-col '>
            <div className='items-center justify-center flex px-3 py-2 rounded-[14px] bg-[#EBD4EF] '>
              <span className='text-[#9C28B1] leading-normal font-semibold text-[28px]'>01.</span>
            </div>
            <p className='self-stretch text-black text-[22px] font-bold leading-normal uppercase'>
